import type { ContractNetworkConfig, ResolvedSdkConfig } from '../core/types.js';
...
function networkFromRegistry(caip2: string): ContractNetworkConfig {
...
export function buildBnbpayTestnetsPreset(): Pick<ResolvedSdkConfig, 'preset' | 'contracts'> {
...
): Pick<ResolvedSdkConfig, 'preset' | 'contracts'> {
