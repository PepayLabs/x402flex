...
export type TokenSymbol = "BNB" | "USDT" | "USDC" | "FDUSD" | "BNBUSD" | "USD1" | "WUSD" | "XUSD";
...
export type TokenInfo = {
  ...
  name: string;
  decimals: number;
  address?: string; // undefined for native BNB
  isNative?: boolean;
  capabilities?: TokenCapabilities;
};

export const tokens: Record<ChainId, Record<TokenSymbol, TokenInfo>> = {
  56: {
...
export const tokenAliases: Record<string, TokenSymbol> = {
  bnb: "BNB",
  usdt: "USDT",
  usdc: "USDC",
  fdusd: "FDUSD",
