 ...
 */
export function calculateFee(amount, feeBps = 0) {
 ...
 */
export function calculateTotalWithFee(merchantAmount, feeBps = 0) {
 ...
 */
export function isValidFeeBps(feeBps) {
 ...
 */
export function parseFeePercentage(feeStr) {
 ...
 */
export function getFeeBreakdownMessage(amount, feeBps, currency = 'USD') {
    if (feeBps === 0) {
